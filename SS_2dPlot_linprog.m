...
Cost_C4  =  log.Cost1; 
Cost_ESS   =  log.Cost2; 
Cost_ESS_max  = max(max(Cost_ESS));

% Revenue_C0 =  -log_C0.Cost1       - log_C0.Rev_Esell + Cevcs.*sum(log.EV_ref(:,i,j));
% Revenue_C4 = -Cost_C4 -Cost_ESS_max - log.Rev_Esell+ Cevcs.*sum(log.EV_ref(:,i,j));
...
% load('data_230321_SS_LowSun.mat')
...
% saveas(f1,'fig1_230321_SS.epsc')
% saveas(f1,'fig1_230321_SS.fig')
% % 
% saveas(f13,'fig2_3_230321_SS.epsc')
% saveas(f13,'fig2_3_230321_SS.fig')