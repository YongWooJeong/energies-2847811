...
f14 = figure
mesh(plt_x,plt_y, Revenue_C4*1000,'FaceAlpha', 0.4,'LineWidth',1);  hold on; grid on;
...
%% %%
% %  
   saveas(f13,'figSOC_230321_YJ.fig')
saveas(f13,'figSOC_230321_YJ.epsc')

   saveas(f12,'figEcap_230321_YJ.fig')
saveas(f12,'figEcap_230321_YJ.epsc')

   saveas(f11,'figEsell_230321_YJ.fig')
saveas(f11,'figEsell_230321_YJ.epsc')

%    saveas(f15,'figEg2cs_230321_YJ.fig')
% saveas(f15,'figEg2cs_230321_YJ.epsc')
% 
   saveas(f14,'figProfit_230321_YJ.fig')
saveas(f14,'figProfit_230321_YJ.epsc')

   saveas(f141,'figP_comp_230321_YJ.fig')
saveas(f141,'figP_comp_230321_YJ.epsc')
% % 


% %  
% % saveas(gcf,'figSOC_230321_YJ.epsc') 
% % saveas(gcf,'figEcap_230321_YJ.epsc') 
% % saveas(gcf,'figEsell_230321_YJ.epsc') 
% % saveas(gcf,'figEg2cs_230309.epsc') 
% % saveas(gcf,'figProfit_230321_YJ.epsc') 
% % saveas(gcf,'figP_comp_230321_YJ.epsc')
% % 
